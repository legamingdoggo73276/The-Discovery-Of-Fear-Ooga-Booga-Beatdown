...
right = pygame.image.load("images/caveright.png").convert_alpha()
topright = pygame.image.load("images/wall_midright.png").convert_alpha()
...
class cell_2(Map):
    rect1 = pygame.Rect(0, 0, 488, 800)
    rect2 = pygame.Rect(680, 0, 520, 800)
